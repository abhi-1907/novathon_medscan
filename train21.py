...
df = df.head(1000)  # For testing purposes, we are limiting to 5 rows. You can remove this for full data.
...
train_inputs, test_inputs, train_labels, test_labels = train_test_split(train_inputs, train_labels, test_size=0.2)
